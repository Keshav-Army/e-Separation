...
const HrDashboard = (props) => {
  ...
  // Below is new search function calling on button click=============>>>>>>>>
  ...
  // Handleing page change with a check to avoid unnecessary API calls , and we are avoid refetch if the page is the same.
